...
public final class FragmentLogBinding implements ViewBinding {
  ...
  private FragmentLogBinding(@NonNull LinearLayout rootView, @NonNull TextView tcplog,
      @NonNull TextView tcplogtitle, @NonNull TextView thingspeaklog,
  ...
  public static FragmentLogBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLogBinding((LinearLayout) rootView, tcplog, tcplogtitle, thingspeaklog,
          thingspeaklogtitle);
    }
