package com.example.sending_app1;
...
import com.example.sending_app1.databinding.ActivityMainBinding;
...
public class sending_app1 extends AppCompatActivity implements SensorEventListener, OnFragmentInteractionListener {
    ...
    {
        return true && isAudioRecordPermissionGranted && isFineLocationPermissionGranted;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        com.example.sending_app1.databinding.ActivityMainBinding activityMainBinding = ActivityMainBinding.inflate(LayoutInflater.from(this));
...
mSendBlockNames = getResources().getStringArray(R.array.tcpSendBlockNames);
    ...
    private sending_app1 thisClass;
    private final Thread BgThread = new Thread() {
    @Override
    public void run() {
            String argv[] = new String[] {"MainActivity","sending_app1"};
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        if (!checkIfAllPermissionsGranted() && !isAudioRecordPermissionRequested && !isFineLocationPermissionRequested) {
            requestPermission();
        }
    }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Log.e("sending_app1.updateTextViewById", ex.getLocalizedMessage());
                }
            }
        });
    }
...
public void audioFileReadTerminate(int idx) {
    ...
    private native int naMain(String[] argv, sending_app1 pThis);
    private native void naOnAppStateChange(int state);
    static {
        System.loadLibrary("sending_app1");
    }
