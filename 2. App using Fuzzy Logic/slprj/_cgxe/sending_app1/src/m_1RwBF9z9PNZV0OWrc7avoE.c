...
static emlrtRSInfo emlrtRSI = { 1,     /* lineNo */
  ...
  "C:\\ProgramData\\MATLAB\\SupportPackages\\R2022b\\toolbox\\target\\supportpackages\\android\\+codertarget\\+internal\\androidDataDisplay.p"/* pathName */
};
...
static void cgxe_mdl_start(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
...
static void cgxe_mdl_set_sim_state(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_1RwBF9z9PNZV0OWrc7avoE
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S, int_T tid)
{
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S)
{
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S, int_T tid)
{
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)cgxertGetRuntimeInstance(S);
...
static void setSimState_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S)
{
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S)
{
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S)
{
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S)
{
  InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *moduleInstance =
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE *)calloc(1, sizeof
    (InstanceStruct_1RwBF9z9PNZV0OWrc7avoE));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_1RwBF9z9PNZV0OWrc7avoE);
  ssSetmdlInitializeConditions(S, mdlInitialize_1RwBF9z9PNZV0OWrc7avoE);
  ssSetmdlUpdate(S, mdlUpdate_1RwBF9z9PNZV0OWrc7avoE);
  ssSetmdlTerminate(S, mdlTerminate_1RwBF9z9PNZV0OWrc7avoE);
  ssSetmdlEnable(S, mdlEnable_1RwBF9z9PNZV0OWrc7avoE);
  ssSetmdlDisable(S, mdlDisable_1RwBF9z9PNZV0OWrc7avoE);
...
static void mdlProcessParameters_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S)
{
}

void method_dispatcher_1RwBF9z9PNZV0OWrc7avoE(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_1RwBF9z9PNZV0OWrc7avoE(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_1RwBF9z9PNZV0OWrc7avoE(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_1RwBF9z9PNZV0OWrc7avoE(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_1RwBF9z9PNZV0OWrc7avoE(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 1RwBF9z9PNZV0OWrc7avoE.\n"
...
mxArray *cgxe_1RwBF9z9PNZV0OWrc7avoE_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_1RwBF9z9PNZV0OWrc7avoE_fallback_info(void)
{
