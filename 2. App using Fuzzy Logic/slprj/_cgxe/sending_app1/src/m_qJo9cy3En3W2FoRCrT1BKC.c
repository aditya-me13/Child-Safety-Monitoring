...
static void cgxe_mdl_start(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_qJo9cy3En3W2FoRCrT1BKC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S, int_T tid)
{
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S)
{
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S, int_T tid)
{
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S)
{
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S)
{
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S)
{
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S)
{
  InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *moduleInstance =
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC *)calloc(1, sizeof
    (InstanceStruct_qJo9cy3En3W2FoRCrT1BKC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_qJo9cy3En3W2FoRCrT1BKC);
  ssSetmdlInitializeConditions(S, mdlInitialize_qJo9cy3En3W2FoRCrT1BKC);
  ssSetmdlUpdate(S, mdlUpdate_qJo9cy3En3W2FoRCrT1BKC);
  ssSetmdlTerminate(S, mdlTerminate_qJo9cy3En3W2FoRCrT1BKC);
  ssSetmdlEnable(S, mdlEnable_qJo9cy3En3W2FoRCrT1BKC);
  ssSetmdlDisable(S, mdlDisable_qJo9cy3En3W2FoRCrT1BKC);
...
static void mdlProcessParameters_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S)
{
}

void method_dispatcher_qJo9cy3En3W2FoRCrT1BKC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_qJo9cy3En3W2FoRCrT1BKC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_qJo9cy3En3W2FoRCrT1BKC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_qJo9cy3En3W2FoRCrT1BKC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_qJo9cy3En3W2FoRCrT1BKC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: qJo9cy3En3W2FoRCrT1BKC.\n"
...
mxArray *cgxe_qJo9cy3En3W2FoRCrT1BKC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_qJo9cy3En3W2FoRCrT1BKC_fallback_info(void)
{
