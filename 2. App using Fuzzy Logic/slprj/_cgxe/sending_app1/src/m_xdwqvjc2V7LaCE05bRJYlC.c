...
static void cgxe_mdl_start(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
...
static void cgxe_mdl_set_sim_state(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_xdwqvjc2V7LaCE05bRJYlC
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S, int_T tid)
{
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S)
{
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S, int_T tid)
{
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)cgxertGetRuntimeInstance(S);
...
static void setSimState_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S)
{
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S)
{
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S)
{
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S)
{
  InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *moduleInstance =
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC *)calloc(1, sizeof
    (InstanceStruct_xdwqvjc2V7LaCE05bRJYlC));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_xdwqvjc2V7LaCE05bRJYlC);
  ssSetmdlInitializeConditions(S, mdlInitialize_xdwqvjc2V7LaCE05bRJYlC);
  ssSetmdlUpdate(S, mdlUpdate_xdwqvjc2V7LaCE05bRJYlC);
  ssSetmdlTerminate(S, mdlTerminate_xdwqvjc2V7LaCE05bRJYlC);
  ssSetmdlEnable(S, mdlEnable_xdwqvjc2V7LaCE05bRJYlC);
  ssSetmdlDisable(S, mdlDisable_xdwqvjc2V7LaCE05bRJYlC);
...
static void mdlProcessParameters_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S)
{
}

void method_dispatcher_xdwqvjc2V7LaCE05bRJYlC(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_xdwqvjc2V7LaCE05bRJYlC(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_xdwqvjc2V7LaCE05bRJYlC(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_xdwqvjc2V7LaCE05bRJYlC(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_xdwqvjc2V7LaCE05bRJYlC(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: xdwqvjc2V7LaCE05bRJYlC.\n"
...
mxArray *cgxe_xdwqvjc2V7LaCE05bRJYlC_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_xdwqvjc2V7LaCE05bRJYlC_fallback_info(void)
{
