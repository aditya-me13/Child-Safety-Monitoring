...
static void cgxe_mdl_start(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance);
static void cgxe_mdl_initialize(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance);
static void cgxe_mdl_outputs(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance);
static void cgxe_mdl_update(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance);
static void cgxe_mdl_enable(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance);
static void cgxe_mdl_disable(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance);
static void cgxe_mdl_terminate(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance);
static void mw__internal__call__setup(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance, const emlrtStack *sp);
static void SystemCore_setup(const emlrtStack *sp,
  codertarget_internal_androidDataDisplay *obj);
static void mw__internal__call__reset(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance, const emlrtStack *sp);
static void mw__internal__call__step(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance, const emlrtStack *sp);
static const mxArray *emlrt_marshallOut(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance);
static const mxArray *cgxe_mdl_get_sim_state
  (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance);
static void emlrt_marshallIn(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
...
static void cgxe_mdl_set_sim_state(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
...
static boolean_T h_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId);
static void init_simulink_io_address(InstanceStruct_39dYKqcIOj3tuPvS2vxNOH
  *moduleInstance);
...
/* CGXE Glue Code */
static void mdlOutputs_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S, int_T tid)
{
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)cgxertGetRuntimeInstance(S);
  cgxe_mdl_outputs(moduleInstance);
}

static void mdlInitialize_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S)
{
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)cgxertGetRuntimeInstance(S);
...
static void mdlUpdate_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S, int_T tid)
{
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)cgxertGetRuntimeInstance(S);
...
static mxArray* getSimState_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S)
{
  mxArray* mxSS;
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)cgxertGetRuntimeInstance(S);
...
static void setSimState_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S, const mxArray *ss)
{
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)cgxertGetRuntimeInstance(S);
...
static void mdlTerminate_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S)
{
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)cgxertGetRuntimeInstance(S);
...
static void mdlEnable_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S)
{
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)cgxertGetRuntimeInstance(S);
...
static void mdlDisable_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S)
{
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)cgxertGetRuntimeInstance(S);
...
static void mdlStart_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S)
{
  InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *moduleInstance =
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH *)calloc(1, sizeof
    (InstanceStruct_39dYKqcIOj3tuPvS2vxNOH));
  moduleInstance->S = S;
  cgxertSetRuntimeInstance(S, (void *)moduleInstance);
  ssSetmdlOutputs(S, mdlOutputs_39dYKqcIOj3tuPvS2vxNOH);
  ssSetmdlInitializeConditions(S, mdlInitialize_39dYKqcIOj3tuPvS2vxNOH);
  ssSetmdlUpdate(S, mdlUpdate_39dYKqcIOj3tuPvS2vxNOH);
  ssSetmdlTerminate(S, mdlTerminate_39dYKqcIOj3tuPvS2vxNOH);
  ssSetmdlEnable(S, mdlEnable_39dYKqcIOj3tuPvS2vxNOH);
  ssSetmdlDisable(S, mdlDisable_39dYKqcIOj3tuPvS2vxNOH);
...
static void mdlProcessParameters_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S)
{
}

void method_dispatcher_39dYKqcIOj3tuPvS2vxNOH(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_39dYKqcIOj3tuPvS2vxNOH(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_39dYKqcIOj3tuPvS2vxNOH(S);
    break;

   case SS_CALL_MDL_GET_SIM_STATE:
    *((mxArray**) data) = getSimState_39dYKqcIOj3tuPvS2vxNOH(S);
    break;

   case SS_CALL_MDL_SET_SIM_STATE:
    setSimState_39dYKqcIOj3tuPvS2vxNOH(S, (const mxArray *) data);
    break;
   ...
   default:
    ...
    /*
       ...
       "Error calling method dispatcher for module: 39dYKqcIOj3tuPvS2vxNOH.\n"
...
mxArray *cgxe_39dYKqcIOj3tuPvS2vxNOH_BuildInfoUpdate(void)
{
  mxArray * mxBIArgs;
  mxArray * elem_1;
  mxArray * elem_2;
...
mxArray *cgxe_39dYKqcIOj3tuPvS2vxNOH_fallback_info(void)
{
