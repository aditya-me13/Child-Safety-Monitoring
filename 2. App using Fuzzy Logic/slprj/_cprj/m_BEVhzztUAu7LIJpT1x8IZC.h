#ifndef __BEVhzztUAu7LIJpT1x8IZC_h__
#define __BEVhzztUAu7LIJpT1x8IZC_h__
...
#ifndef typedef_codertarget_internal_androidAudioCapture
#define typedef_codertarget_internal_androidAudioCapture

typedef struct tag_gqk06dR469AcJbzzWY0lrD
  codertarget_internal_androidAudioCapture;

#endif                                 /* typedef_codertarget_internal_androidAudioCapture */
...
typedef struct tag_7rClNlx2n452lpFDKKJsJH cell;

#endif                                 /* typedef_cell */

#ifndef struct_tag_hfuMxtM3511pO8GfZjii3B
#define struct_tag_hfuMxtM3511pO8GfZjii3B

struct tag_hfuMxtM3511pO8GfZjii3B
{
  char_T f1[8];
};

#endif                                 /* struct_tag_hfuMxtM3511pO8GfZjii3B */

#ifndef typedef_cell_wrap
#define typedef_cell_wrap

typedef struct tag_hfuMxtM3511pO8GfZjii3B cell_wrap;
...
#ifndef struct_tag_vwCbYnpZfeCHUW3PAXIELH
#define struct_tag_vwCbYnpZfeCHUW3PAXIELH

struct tag_vwCbYnpZfeCHUW3PAXIELH
{
  char_T f1[4];
  char_T f2[6];
  char_T f3[6];
...
#endif                                 /* struct_tag_vwCbYnpZfeCHUW3PAXIELH */

#ifndef typedef_b_cell
#define typedef_b_cell

typedef struct tag_vwCbYnpZfeCHUW3PAXIELH b_cell;
...
typedef struct tag_Hm6EPE5ncyWd4RGCxxctzF c_cell;
...
typedef struct tag_n5V6NPhGd1s3l2q7z9eOR d_cell;
...
typedef struct tag_VqK0uXiUXuliBvHmvcLR0F e_cell;
...
#ifndef struct_tag_r8oingdPeAlKT8PJg7lrLB
#define struct_tag_r8oingdPeAlKT8PJg7lrLB

struct tag_r8oingdPeAlKT8PJg7lrLB
{
  cell_wrap _data;
};

#endif                                 /* struct_tag_r8oingdPeAlKT8PJg7lrLB */

#ifndef typedef_s_r8oingdPeAlKT8PJg7lrLB
#define typedef_s_r8oingdPeAlKT8PJg7lrLB

typedef struct tag_r8oingdPeAlKT8PJg7lrLB s_r8oingdPeAlKT8PJg7lrLB;

#endif                                 /* typedef_s_r8oingdPeAlKT8PJg7lrLB */
...
#ifndef struct_tag_qyZGi2e7CQ5PIKdopsHLkF
#define struct_tag_qyZGi2e7CQ5PIKdopsHLkF

struct tag_qyZGi2e7CQ5PIKdopsHLkF
{
  b_cell _data;
};

#endif                                 /* struct_tag_qyZGi2e7CQ5PIKdopsHLkF */

#ifndef typedef_s_qyZGi2e7CQ5PIKdopsHLkF
#define typedef_s_qyZGi2e7CQ5PIKdopsHLkF

typedef struct tag_qyZGi2e7CQ5PIKdopsHLkF s_qyZGi2e7CQ5PIKdopsHLkF;

#endif                                 /* typedef_s_qyZGi2e7CQ5PIKdopsHLkF */
...
#ifndef typedef_InstanceStruct_BEVhzztUAu7LIJpT1x8IZC
#define typedef_InstanceStruct_BEVhzztUAu7LIJpT1x8IZC

typedef struct {
  SimStruct *S;
  codertarget_internal_androidAudioCapture sysobj;
  boolean_T sysobj_not_empty;
  void *emlrtRootTLSGlobal;
  int16_T (*b_y0)[600];
} InstanceStruct_BEVhzztUAu7LIJpT1x8IZC;

#endif                                 /* typedef_InstanceStruct_BEVhzztUAu7LIJpT1x8IZC */
...
extern void method_dispatcher_BEVhzztUAu7LIJpT1x8IZC(SimStruct *S, int_T method,
  void* data);
